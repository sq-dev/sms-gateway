...
/**
 * SMSGate `SmsType` codes documented in the HTTP API.
 *
 ...
 * in the SMSGate namespace because it has no meaning for other adapters.
 *
...
enum SmsType: int
{
    ...
    /** One-time passwords / 2FA codes. SMSGate routes these on a faster path. */
    case Otp = 2;
